								...
								<div class="panel-body">
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/anchorunion/save"
											method="post">			
											<input type="hidden" name="id" value="${anchorUnion.id}"/>								
											<div class="form-group">
												<label class="col-sm-2 control-label">工会名称：</label>
												<div class="col-sm-5">
													<input type="text" name="name" class="form-control" value="${anchorUnion.name}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">分成比例：</label>
												<div class="col-sm-5">
													<input type="text" name="divide_proportion" class="form-control" value="${anchorUnion.divide_proportion}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">一对一分成比例：</label>
												<div class="col-sm-5">
													<input type="text" name="one_divide_proportion" class="form-control" value="${anchorUnion.one_divide_proportion}">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-5">
													<select name="type" class="form-control">
													     ...
													     <option value = "0" <c:if test="${anchorUnion.type==0}">selected="selected"</c:if>>周结</option>
													     <option value = "1" <c:if test="${anchorUnion.type==1}">selected="selected"</c:if>>日结</option>
													</select>
												</div>
											</div>												
											<div class="form-group">
												...
												<div class="col-sm-5">
													<textarea rows="3" class="form-control" name="remark">${anchorUnion.remark}</textarea>
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">设置工会后台用户名：</label>
												<div class="col-sm-5">
													<input type="text" name="username" class="form-control"value="${anchorUnion.username}">
												</div>
											</div>
											<div class="form-group">
												...
												<span class="col-sm-5 help-block m-b-none text-danger"
														style="color: blue">不修改可留空</span>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">会长昵称：</label>
												<div class="col-sm-5">
													<input type="text" name="commander" placeholder="请填写您的昵称" class="form-control"value="${anchorUnion.commander}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">微信号：</label>
												<div class="col-sm-5">
													<input type="text" name="weixin" placeholder="请填写微信号" class="form-control"value="${anchorUnion.weixin}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">QQ号：</label>
												<div class="col-sm-5">
													<input type="text" name="qq" class="form-control"value="${anchorUnion.qq}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">手机号：</label>
												<div class="col-sm-5">
													<input type="text" name="tel" placeholder="请填写11位数手机号" class="form-control"value="${anchorUnion.tel}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">邮箱：</label>
												<div class="col-sm-5">
													<input type="text" name="email" placeholder="请填写邮箱" class="form-control"value="${anchorUnion.email}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">持卡人：</label>
												<div class="col-sm-5">
													<input type="text" name="card_holder" class="form-control"value="${anchorUnion.card_holder}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">银行卡号：</label>
												<div class="col-sm-5">
													<input type="text" name="bank_card_no" class="form-control"value="${anchorUnion.bank_card_no}">
												</div>
											</div>	
											<div class="form-group">
												...
												<div class="col-sm-2">
													<select name="province" class="form-control" onchange="setCity(this);">
														...
														<c:forEach items="${areaList}" var="area">
															<option value="${area.id}"<c:if test="${area.id==anchorUnion.province}"> selected="selected"</c:if>>${area.name}</option>
															</c:forEach>
													</select>
												</div>
												<div class="col-sm-2">
													<select name="city" class="form-control">
														...
														<c:forEach items="${areaList2}" var="area">
															<option value="${area.id}"<c:if test="${area.id==anchorUnion.city}"> selected="selected"</c:if>>${area.name}</option>
															</c:forEach>
													</select>
												</div>
											</div>	
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" name="bank_name" placeholder="请填写开户银行名称" class="form-control"value="${anchorUnion.bank_name}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">公司名称：</label>
												<div class="col-sm-5">
													<input type="text" name="company" class="form-control"value="${anchorUnion.company}">
												</div>
											</div>	
											<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput" type="file" /><input
															type="hidden" id="imageHidden" name="business_license" value="${anchorUnion.business_license}"/>
														<div id="singleDiv"></div>
														<img src="${uploadUrl}${anchorUnion.business_license}" class="wd200 mt10 <c:if test="${empty anchorUnion.business_license}">hide</c:if>" id="image" />
													</div>
												</div>
											</div>
											<div class="form-group">
