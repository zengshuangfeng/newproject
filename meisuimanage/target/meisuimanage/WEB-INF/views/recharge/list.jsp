...
<div id="wrapper">
	...
	<div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight ecommerce">
			<c:set
				value="&uid=${uid}&f_uuid=${f_uuid}&o_id=${o_id}&nickname=${nickname}&type=${type}&pay_type=${pay_type}&platform_channel=${platform_channel}&is_pay=${is_pay}&start_time=${start_time}&end_time=${end_time}&operate_center_id=${operate_center_id}&agent_id=${agent_id}"
				var="query" />
			<div class="row">
				<div class="col-lg-12">
