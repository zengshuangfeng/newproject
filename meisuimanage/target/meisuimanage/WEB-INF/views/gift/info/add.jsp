											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<select name="gift_type" class="form-control" id="gift_type">
														<option value="0"<c:if test="${gift_type==0}"> selected="selected"</c:if>>连击</option>
														<option value="1"<c:if test="${gift_type==1}"> selected="selected"</c:if>>特效连击</option>
														<option value="2"<c:if test="${gift_type==2}"> selected="selected"</c:if>>飘屏</option>
														<option value="3"<c:if test="${gift_type==3}"> selected="selected"</c:if>>钥匙</option>
														<option value="4"<c:if test="${gift_type==4}"> selected="selected"</c:if>>星座</option>
													</select>
												</div>
											</div>	
											<div class="form-group hide" id="gift_time">
												<label class="col-sm-2 control-label">礼物时长：</label>
												<div class="col-sm-5">
													<input type="text" name="gift_time" class="form-control">
												</div>
											</div>
											<div class="form-group hide" id="gift_head2">
												<label class="col-sm-2 control-label">星座动图小图：</label>
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput2" type="file" /><input
															type="hidden" id="imageHidden2" name="gift_head2" />
														<div id="singleDiv2"></div>
														<img src="" class="hide wd200" id="image2" />
													</div>
												</div>
											</div>	
											<div class="form-group hide" id="gift_webp">
												<label class="col-sm-2 control-label">星座动图：</label>
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput1" type="file" /><input
															type="hidden" id="imageHidden1" name="gift_webp" />
...
<script type="text/javascript">
	...
	$(function(){	
		...
		singleImage("#fileInput1", "meisui", "#image1", "input[name=gift_webp]", "singleDiv1");
