											...
											<div class="col-sm-2">
												<div class="form-group">
													<label class="control-label" for="status">&nbsp</label> <a
														href="${BASE_PATH}/guardchange/add" class="input-group">
													...
													<table
														...
														<thead>
															<tr>
																...
																<th class="text-center">充值名称</th>
																<th class="text-center">守护套餐价格</th>
																<th class="text-center">特权头像装饰</th>
																<th class="text-center">特权入场特效</th>
															...
															<c:forEach items="${guardchangeList}" var="change">
																...
																<c:if test="${change.type==2}">包年守护</c:if>
																	...
																	<a
																		...
																		href="${BASE_PATH}/guardchange/edit?id=${change.id}">编辑</a>    
																	</td>
																</tr>
															</c:forEach>
														</tbody>
		...
		$(".onoffswitch-checkbox").click(function() {
			...
			swal({
				...
				if (isConfirm) {
					$.ajax({
						type : "POST",
						url : "${BASE_PATH}/guardchange/updateisonline",
						data : {
							id : id,
