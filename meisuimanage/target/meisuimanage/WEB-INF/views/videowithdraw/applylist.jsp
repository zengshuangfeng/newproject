		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>提现管理</a></li>
					<li class="active"><strong>申请列表</strong></li>
				</ol>
			</div>
		</div>
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="m-b-sm">
										<form action="${BASE_PATH}/withdrawapply/list" autocomplete="off"
														...
														<tbody>
															<c:forEach items="${videoWithdrawList}" var="videoWithdraw">
																<tr class="text-center">
																	...
																	<td>
																		<c:choose>
																			<c:when test="${videoWithdraw.status==0}">
																				<a
																				href="javascript:audit(${videoWithdraw.id},1,'通过')"
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<form id="refuse" action="${BASE_PATH}/withdrawapply/audit" method="post">
							...
							<input type="hidden" name="is_from" value="0"/>
...
<script type="text/javascript">
	...
	function audit(id, status, title)
	{
		swal({
			...
			if (isConfirm) {
				$.ajax({type: "POST",url:"${BASE_PATH}/withdrawapply/audit",data:{id:id,status:status},success:function(data){
					if(data==-2)
					{
						swal({
							title: "",
