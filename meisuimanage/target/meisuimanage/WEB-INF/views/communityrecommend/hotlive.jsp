		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>社区</a></li>
					<li class="active"><strong>热门直播列表</strong></li>
				</ol>
			</div>
		</div>
		<div class="wrapper wrapper-content animated fadeInRight ecommerce">
			<c:set
				value="&f_uuid=${f_uuid}&start_time=${start_time}&end_time=${end_time}"
				var="query" />
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="m-b-sm">
										<form action="${BASE_PATH}/community/hotlive"
												...
												<div class="col-sm-2">
													<div class="form-group">
														<label class="control-label" for="status">&nbsp;</label> <a
															href="${BASE_PATH}/community/hotlive/add"
															class="input-group">
														...
														<tbody>
															<c:forEach items="${CommunityList}" var="CommunityList">
																<tr class="text-center">
																	...
																	<td>${CommunityList.f_uuid}</td>																	
																	<td class="col-xs-1">
																		<c:choose><c:when test="${not empty CommunityList.pic}">
																	...
																	<td class="text-right footable-last-column"><a
																		...
																		href="${BASE_PATH}/community/hotlive/edit?id=${CommunityList.id}">编辑</a>
...
<script type="text/javascript">
	function deleteGiftInfo(id) {
		deleteConfirm(id, "${BASE_PATH}/community/hotlive/delete", "该信息");
	}
</script>