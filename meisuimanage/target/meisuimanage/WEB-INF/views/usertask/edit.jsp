									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/usertask/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="type" class="form-control">
														<option value="1"<c:if test="${userTask.type==1}"> selected="selected"</c:if>>分享主播</option>
														<option value="2"<c:if test="${userTask.type==2}"> selected="selected"</c:if>>游戏获胜</option>
														<option value="3"<c:if test="${userTask.type==3}"> selected="selected"</c:if>>打赏主播</option>
													</select>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="name" class="form-control" value="${userTask.name}">
												</div>
											</div>		
											<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput" type="file" /><input
															type="hidden" id="imageHidden" name="icon" value="${userTask.icon}"/>
														<div id="singleDiv"></div>
														<c:choose>
															<c:when test="${empty userTask.icon}">
																<img src="" class="hide" id="image" />
															</c:when>
															<c:otherwise>
																<img src="${uploadUrl}${userTask.icon}" class="mt10" id="image" />
															</c:otherwise>
														</c:choose>
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" name="num" class="form-control" value="${userTask.num}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">奖励钻石：</label>
												<div class="col-sm-4">
													<input type="text" name="reward_count" class="form-control" value="${userTask.reward_count}">
												</div>
											</div>	
											<div class="form-group">
												<label class="col-sm-2 control-label">排序：</label>
												<div class="col-sm-4">
													<input type="text" name="sort" class="form-control" value="${userTask.sort}">
												</div>
											</div>
											<div class="form-group">
