		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>主播管理</a></li>
					<li><strong><a href="${BASE_PATH}/anchorguard/list">守护列表</a></strong>
					</li>
                            ...
                            <div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/anchorguard/save"
											method="post">											
											...
											<div class="form-group">
												...
												<div class="form-group">
												<label class="col-sm-2 control-label">守护套餐：</label>
												<div class="col-sm-2">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">是否需要支付钻石：</label>
												<div class="col-sm-10">
													<div class="radio radio-inline">
														<input type="radio" value="0" name="need_pay"
															checked="checked" /> <label for="inlineRadio1">&nbsp;否</label>
													</div>
													<div class="radio  radio-info radio-inline">
														<input type="radio" value="1" class="ml15"
															name="need_pay" /> <label for="inlineRadio2">&nbsp;是</label>
													</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
													<font color="blue">选择支付，将会在用户余额扣除相应钻石</font>
												</div>
											</div>
											<div class="form-group">
...
<script type="text/javascript">
	var jumpUrl = "${BASE_PATH}/anchorguard/list";
	$().ready(function() {
		$("#tab").validate({
			rules: {
	...
	$(function(){	
		$("input[name=anchor_f_uuid]").change(function(){
			$.get("${BASE_PATH}/anchorguard/getfuuidexist",{anchor_f_uuid:$(this).val()},function(json){
	...
	$(function(){	
		$("input[name=uid]").change(function(){
			$.get("${BASE_PATH}/anchorguard/getuidexist",{uid:$(this).val()},function(json){
	...
	$(function(){	
		$("#change_id").change(function(){
			$.get("${BASE_PATH}/anchorguard/getchangeid",{change_id:$(this).val(),anchor_f_uuid:$("#anchor_f_uuid").val(),uid:$("#uid").val()},function(json){
			    $("#change_id").next("label").remove();
			 if(json.code==-1) 
				{
					$("#change_id").next("label").remove();
