									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/product/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="0" name="type" checked="checked"/> <label for="inlineRadio1">&nbsp;钥匙兑换奖品</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="1" class="ml15"
															name="type"/> <label for="inlineRadio2">&nbsp;现金购买商品</label>
													</div>
												</div>
											</div>											
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<textarea rows="3" class="form-control" name="issue">购买成功后将在3个工作日内寄出，请确保收件地址无误</textarea>
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">领奖提示：</label>
												<div class="col-sm-5">
													<textarea rows="3" class="form-control" name="tips">该活动和商品与苹果公司无关，由天香直播官方提供，最终解释权归天香直播官方所有</textarea>
												</div>
											</div>											
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="is_online"
															checked="checked" /> <label for="inlineRadio1">&nbsp;上架</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
															name="is_online" /> <label for="inlineRadio2">&nbsp;下架</label>
													</div>
												</div>
											</div>
											<div class="form-group">
