									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/guardchangenew/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" name="change_virtual" class="form-control">
												</div>
											</div>	
												<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload2" id="fileInput2" type="file" /><input
															type="hidden" id="imageHidden2" name="vehicle_pic" />
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload3" id="fileInput3" type="file" /><input
															type="hidden" id="imageHidden3" name="exclusive_pic" />
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload4" id="fileInput4" type="file" /><input
															type="hidden" id="imageHidden4" name="guard_head_big" />
														<div id="singleDiv4"></div>
														<img src="" class="hide wd200" id="image4" />
													</div>
													<span class="col-sm-5 help-block m-b-none text-danger"
														style="color: blue">&nbsp;&nbsp;&nbsp;只支持.PNG 格式 200x200</span>
												</div>
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload5" id="fileInput5" type="file" /><input
															type="hidden" id="imageHidden5" name="entrance_pic_big" />
														<div id="singleDiv5"></div>
														<img src="" class="hide wd200" id="image5" />
													</div>
													<span class="col-sm-5 help-block m-b-none text-danger"
														style="color: blue">&nbsp;&nbsp;&nbsp;只支持.PNG 格式 200x200</span>
												</div>
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload6" id="fileInput6" type="file" /><input
															type="hidden" id="imageHidden6" name="vehicle_pic_big" />
														<div id="singleDiv6"></div>
														<img src="" class="hide wd200" id="image6" />
													</div>
													<span class="col-sm-5 help-block m-b-none text-danger"
														style="color: blue">&nbsp;&nbsp;&nbsp;只支持.PNG 格式 200x200</span>
												</div>
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload7" id="fileInput7" type="file" /><input
															type="hidden" id="imageHidden7" name="exclusive_pic_big" />
														<div id="singleDiv7"></div>
														<img src="" class="hide wd200" id="image7" />
													</div>
													<span class="col-sm-5 help-block m-b-none text-danger"
														style="color: blue">&nbsp;&nbsp;&nbsp;只支持.PNG 格式 200x200</span>
												</div>
