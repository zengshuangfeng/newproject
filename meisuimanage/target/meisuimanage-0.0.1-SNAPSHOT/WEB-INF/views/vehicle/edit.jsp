									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/vehicle/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<textarea name="info" class="form-control"style="height: 120px;" placeholder="请输入座驾简介">${vehicle.info}</textarea>
												</div>
											</div>	
												<div class="form-group">
												...
												<div class="col-sm-2">
													<select name="level" class="form-control">
														...
														<option value="3" <c:if test="${vehicle.level==3}"> selected="selected"</c:if>>黄金座驾</option>
														<option value="2" <c:if test="${vehicle.level==2}"> selected="selected"</c:if>>白银座驾</option>
														<option value="1" <c:if test="${vehicle.level==1}"> selected="selected"</c:if>>青铜座驾</option>
														<option value="0" <c:if test="${vehicle.level==0}"> selected="selected"</c:if>>普通座驾</option>
													</select>
												</div>
											</div>	
												<div class="form-group">
												...
												<div class="col-sm-2">
													<select name="type" class="form-control">
														<option value="-1">请选择</option>														
														<option value="0" <c:if test="${vehicle.type==0}"> selected="selected"</c:if>>普通车型</option>
														<option value="1" <c:if test="${vehicle.type==1}"> selected="selected"</c:if>>神秘车型</option>
													</select>
												</div>
											</div>								
											<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput" type="file" /><input
															type="hidden" id="imageHidden" name="pic" value="${vehicle.pic}"/>
														<div id="singleDiv"></div>
														<img src="${uploadUrl}${vehicle.pic}" class="wd200 mt10" id="image" />
													</div>
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload2" id="fileInput2" type="file" /><input
															type="hidden" id="imageHidden2" name="static_pic" value="${vehicle.static_pic}"/>
														<div id="singleDiv2"></div>
														<img src="${uploadUrl}${vehicle.static_pic}" class="wd200 mt10" id="image2" />
													</div>
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput3" type="file" /><input
															type="hidden" id="imageHidden3" name="special_pic" value="${vehicle.special_pic}"/>
														<div id="singleDiv3"></div>
														<img src="${uploadUrl}${vehicle.special_pic}" class="wd200 mt10" id="image3" />
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" name="alias_name" class="form-control" value="${vehicle.alias_name}">
												</div>
											</div>
											<div class="form-group">
												<label class="col-sm-2 control-label">座驾期限：</label>
												<div class="col-sm-2">
													<input type="text" name="time_limit" class="form-control" value="${vehicle.time_limit}">
												</div>
										...
										<%-- 
											<div class="form-group">
												<label class="col-sm-2 control-label">座驾稀有度：</label>
													<div id="starttwo" class="block clearfix">
      												 ...
      												 <input type="hidden" name="rare_level" id="rare_level" class="form-control" value="${vehicle.rare_level}">
											...
											<input type="hidden" name="divide" value="100">
												...
												<div class="col-sm-2">
													<input type="text" name="divide" class="form-control" value="${vehicle.divide}">
												</div>
												...
												<div class="col-sm-2">
													<input type="text" name="sort" class="form-control" value="${vehicle.sort}">
												</div>
											</div>								
											<div class="form-group">
												...
												<div class="col-sm-5">
													<label class="checkbox-inline i-checks"> <input
														type="checkbox" name="platform" value="10" <c:if test="${vehicle.platform==10||vehicle.platform==00}"> checked="checked"</c:if>>&nbsp;&nbsp;&nbsp;iOS
													</label> <label class="checkbox-inline i-checks"> <input
														type="checkbox" name="platform" value="20"<c:if test="${vehicle.platform==20||vehicle.platform==00}"> checked="checked"</c:if>>&nbsp;&nbsp;&nbsp;安卓
													</label>
												</div>
											</div>		
												<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="is_online"<c:if test="${vehicle.is_online==1}"> checked="checked"</c:if> /> <label for="inlineRadio1">&nbsp;上线</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
															name="is_online" <c:if test="${giftInfo.is_online==0}"> checked="checked"</c:if>/> <label for="inlineRadio2">&nbsp;下线</label>
													</div>
												</div>
											</div>
											<div class="form-group">
