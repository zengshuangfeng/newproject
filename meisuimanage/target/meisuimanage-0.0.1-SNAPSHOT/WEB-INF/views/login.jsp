...
<body class="gray-bg">
	<div class="loginColumns animated fadeInDown">
		<div class="row">
			...
			<div class="col-md-6">
				<h2 class="font-bold">欢迎登录美岁直播管理后台</h2>

				<p>Perfectly designed and precisely prepared admin theme with
					over 50 pages with extra new web app views.</p>
			...
			<div class="col-md-6">
				<div class="ibox-content">
					<form class="m-t" role="form" action="${BASE_PATH}/login/validate"
	...
	<script src="/res/js/jquery-2.1.1.js" type="text/javascript"></script>
