...
<div id="wrapper">
	...
	<div id="page-wrapper" class="gray-bg">
		...
		<div class="wrapper wrapper-content animated fadeInRight ecommerce">
			<c:set value="&video_id=${video_id}&nickname=${nickname}" var="query" />
			<div class="row">
				<div class="col-lg-12">
														...
														<tbody>
															<c:forEach items="${userVideoList}" var="userVideo">
																<tr class="text-center">
																	...
																	<td>
																	<a class="btn btn-xs btn-outline btn-primary" href="javascript:updateVideoStatus(${userVideo.id}, 1)">通过</a>
																	<a class="btn btn-xs btn-outline btn-primary" href="javascript:refuse(${userVideo.id})">不通过</a>
																	</td>
																...
																<td colspan="7" class="footable-visible">
																	<div class="text-center">
																		<a data-toggle="modal" class="btn btn-primary"
																			href="javascript:window.location.reload()">&nbsp;&nbsp;&nbsp;刷&nbsp;&nbsp;新&nbsp;&nbsp;&nbsp;</a>
																	</div>
																</td>
															</tr>
														</tfoot>
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-12">
						...
						<form id="refuse" action="${BASE_PATH}/auditvideo/audit" method="post">		
...
function updateVideoStatus(id, status)
{
	swal({
		title : "",
		text : status==1?"确定要通过该视频？":"确定要不通过该视频？",
		type : "warning",
		...
		if (isConfirm) {
			$.ajax({type: "POST",url:"${BASE_PATH}/auditvideo/audit",data:{id:id,status:status},success:function(){
