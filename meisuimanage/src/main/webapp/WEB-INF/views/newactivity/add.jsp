												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="type"
															checked="checked" /> <label for="inlineRadio1">&nbsp;跳转</label>
													</div>
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="is_share"
															checked="checked" /> <label for="inlineRadio1">&nbsp;可分享</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput2" type="file" /><input
															type="hidden" id="imageHidden2" name="pic" />
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<select name="position" class="form-control">
														<option value="0">直播间banner</option>																						
													</select>
												</div>
											</div>
										<!-- 	<div class="form-group">
												...
												<div class="col-sm-3">
													<select name="time_type" class="form-control">
														...
														<option value="1">时间段内的某个时间点后开启</option>													
													</select>
												</div>
											</div> -->
											<div class="form-group">
