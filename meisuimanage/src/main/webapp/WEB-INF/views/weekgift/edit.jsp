		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>运营管理</a></li>
					<li><strong><a href="${BASE_PATH}/mengyan/list">周星礼物列表</a></strong>
					</li>
								...
								<div class="panel-body">
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/weekgift/save"
											method="post">
											<input type="hidden" class="form-control" name="id" value="${weekgift.id }">
											<div class="form-group">
											<label class="col-sm-2 control-label">礼物名称：</label>
											<div class="col-sm-3">
														<select name="gift_id"class="form-control" readonly="readonly">
															<option value="${weekgift.gift_id}">${weekgift.gift_name}</option>														
														</select>
														</div>
													</div>
											...
											<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">														
														<img src="${uploadUrl}${weekgift.gift_head}" class="wd200" id="image" />
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" class="form-control" name="sort" value="${weekgift.sort }">
												</div>
											</div>
												...
												<div class="col-sm-3">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="is_online"
															<c:if test="${weekgift.is_online==1}"> checked="checked"</c:if>/> <label for="inlineRadio1">&nbsp;正常</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
															name="is_online" <c:if test="${weekgift.is_online==0}"> checked="checked"</c:if>/> <label for="inlineRadio2">&nbsp;禁用</label>
													</div>													
												</div>
											</div>							
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" class="form-control" value="<fmt:formatDate value="${weekgift.online_time}"  pattern="yyyy-MM-dd"></fmt:formatDate> " readonly="readonly"
