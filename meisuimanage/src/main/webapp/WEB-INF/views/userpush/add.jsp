									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/userpush/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<textarea rows="3" class="form-control" name="p_content"></textarea>
												</div>
											</div>	
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" name="href" id="href" class="form-control" placeholder="请输入用户点击推送要跳转的链接，如果跳转主播直播间需要填写主播房间号">
												</div>
											</div>		
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="p_range" checked="checked" id="prange1"/> <label for="inlineRadio3">&nbsp;全部</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
															name="p_range"  id="prange0"/> <label for="inlineRadio4">&nbsp;指定</label>
													</div>
												</div>
											</div>	
											<div class="form-group hide" id="userid">
												<label class="col-sm-2 control-label"></label>
												<div class="col-sm-5">
