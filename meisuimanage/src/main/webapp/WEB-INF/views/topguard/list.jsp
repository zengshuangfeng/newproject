				...
				<div class="col-lg-12">
					<div class="tabs-container">
						<ul class="nav nav-tabs">
							<li><a href="${BASE_PATH}/useranchor/attention/list?attention_uid=${attention_uid}&f_uuid=${f_uuid}">粉丝列表</a></li>
							<li class="active"><a href="#">守护列表</a></li>
													...
													<table
														...
														<thead>
															<tr>
																...
																<th class="text-center">贡献魅力值</th>
															</tr>
														</thead>
														<tbody>
															<c:forEach items="${topGuardList}" var="topGuard">
																<tr class="text-center">
																	<td>${topGuard.uid}</td>
																	<td>${topGuard.nickname}</td>
																	<td>${topGuard.give_count}</td>
																</tr>
															</c:forEach>
														</tbody>
