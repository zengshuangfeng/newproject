									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/anchorrecommend/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" name="f_uuid" class="form-control" id="f_uuid" value="${recommend.f_uuid}" readonly="readonly">
												</div>
											</div>	
												<div class="form-group" id="nicknamehide">
												<label class="col-sm-2 control-label">主播昵称：</label>
												<div class="col-sm-2">
													<input type="text" name="nickname" class="form-control" id="nickname" readonly="readonly" value="${recommend.nickname}">
												</div>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" name="sort" class="form-control" value="${recommend.sort}">
												</div>
											</div>									
