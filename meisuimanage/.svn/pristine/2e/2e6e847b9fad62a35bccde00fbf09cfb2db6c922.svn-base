									...
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/levelprivilege/gradient/save"
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" name="virtual_count" class="form-control">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="1" name="is_online" checked="checked"/> <label for="inlineRadio1">&nbsp;正常</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="0" class="ml15"
															name="is_online"/> <label for="inlineRadio2">&nbsp;关闭</label>
													</div>
												</div>
											</div>
											<div class="form-group">
...
<script type="text/javascript">
	var jumpUrl = "${BASE_PATH}/levelprivilege/gradient/list?p_id=${p_id}";
	$().ready(function() {
		$("#tab").validate({
			rules: {
