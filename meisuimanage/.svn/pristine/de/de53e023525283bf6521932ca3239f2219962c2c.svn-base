		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>礼物管理</a></li>
					<li class="active"><strong>礼物箱礼物</strong></li>
				</ol>
			</div>
		</div>
		<div class="wrapper wrapper-content animated fadeInRight ecommerce">
			<c:set
				value="&gift_id=${gift_id}&gift_name=${gift_name}&is_online=${is_online}&is_private=${is_private}"
				var="query" />
			<div class="row">
				<div class="col-lg-12">
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								<div class="panel-body">
									<div class="m-b-sm">
										<form action="${BASE_PATH}/gift/box"
															...
															<c:forEach items="${giftInfoList}" var="giftInfo">
																<tr class="text-center">
																	...
																	<td class="text-right footable-last-column"><a
																		...
																		href="${BASE_PATH}/gift/box/edit?id=${giftInfo.id}">编辑</a>
