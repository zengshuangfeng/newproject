		...
		<div class="row wrapper border-bottom white-bg page-heading">
			<div class="col-lg-10">
				...
				<ol class="breadcrumb">
					...
					<li><a>监控管理</a></li>
					<li class="active"><strong>警告列表</strong></li>
				</ol>
			</div>
		</div>
					...
					<div class="tabs-container">
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								...
								<div class="m-b-sm">										
										<form action="${BASE_PATH}/waring/list" autocomplete="off" method="get" id="square_form">
											<div class="row">
												<div class="col-sm-1">
														...
														<tbody>
															<c:forEach items="${partnerRecordList}" var="partnerRecord">
																<tr class="text-center">
																	...
																	<td class="col-xs-1"><img class="col-xs-12" src="${fn:startsWith(partnerRecord.pic,'http')?'':uploadUrl}${partnerRecord.pic}${fn:startsWith(partnerRecord.pic,'http')?'':'?imageView2/2/w/200'}"/></td>
...
<div class="modal inmodal" id="myModal" tabindex="-1" data-backdrop="static" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content animated bounceInRight">
			<form id="save_logis_form" method="post" action="${BASE_PATH}/square2/savewaring" class="form-horizontal">
