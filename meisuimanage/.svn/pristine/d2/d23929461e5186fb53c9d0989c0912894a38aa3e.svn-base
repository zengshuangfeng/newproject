											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="0" name="sex" checked="checked"/> <label for="inlineRadio1">&nbsp;男</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="1" 
															name="sex"/> <label for="inlineRadio2">&nbsp;女</label>
													</div>
												</div>
											</div>			
											<div class="form-group">
												...
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput" type="file" /><input
															type="hidden" id="imageHidden" name="head" />
...
<script type="text/javascript">
	...
	$().ready(function() {
		$("#tab").validate({
			...
			submitHandler: function(){
			    ...
			    $("input[name=area]").val( $("select[name=province]").find("option:selected").text() + " " +  $("select[name=city]").find("option:selected").text());
	...
	$(function(){	
		...
		$("input[name=nickname]").blur(function(){
			$.get("${BASE_PATH}/uservest/getnicknameexist",{uid:0,nickname:$(this).val()},function(data){
				if(data==1)
				{
