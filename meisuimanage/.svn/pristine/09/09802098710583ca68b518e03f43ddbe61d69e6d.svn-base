								...
								<div class="panel-body">
									<fieldset class="form-horizontal">
										<form id="tab" action="${BASE_PATH}/mengyan/save"
											method="post">
											<input type="hidden" name="id" value="${mengyan.id}"/>
											<div class="form-group">
												<label class="col-sm-2 control-label">萌颜图片</label>
												<div class="btn-group col-sm-6">
													<div class="fl">
														<input name="upload" id="fileInput" type="file" /><input
															type="hidden" id="imageHidden" name="pic" value="${mengyan.pic}"/>
														<div id="singleDiv"></div>
														<img src="${uploadUrl}${mengyan.pic}" class="wd200 mt10" id="image" />
													</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<div class="radio radio-info radio-inline">
														<input type="radio" value="0" name="type"<c:if test="${mengyan.type==0}"> checked="checked"</c:if>/> <label for="inlineRadio3">&nbsp;胜方</label>
													</div>
													<div class="radio radio-inline">
														<input type="radio" value="1" class="ml15"
															name="type"<c:if test="${mengyan.type==1}"> checked="checked"</c:if>/> <label for="inlineRadio4">&nbsp;负方</label>
													</div>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-2">
													<input type="text" name="sort" class="form-control" value="${mengyan.sort}">
												</div>
											</div>				
